...
var booksData = [
  ...
  },
  {
    ...
    quotes: [
      ...
      { id: 'q18', text: '能够让我们终极地掌握世界的方法，不是寄托在思想之中，而是寄托在行为中，寄托在对一体性的体验中。' },
      { id: 'q19', text: '哲学家们只是用不同的方式解释世界，但真正重要的任务在于改变世界。——马克思' },
      { id: 'q20', text: '现代资本主义需要能顺畅合作的大量人力，需要人们消费越来越多，需要品味标准化以便容易被影响和预期。这些人不用武力就能被指挥，不用领袖就能被领导，不用目的就能被激励。他们只有一个目的：变富、奔忙、运转、前进。' },
      { id: 'q21', text: '今天，人们的幸福是由享受乐趣构成，而享受乐趣意味着囫囵吞枣地咽下大量商品、景色、食物、饮料、香烟、演讲、书籍和电影。我们是吮吸者，永远充满期待，又永远失望。' },
      { id: 'q22', text: '在无数谈论幸福婚姻的文章中，最理想的婚姻都被形容为运作顺畅的团队。这种团队和运作顺畅的雇员团队没多大不同，两者都是要求当事人具备适度的独立性、合作性、容忍性，同时又要具备野心和侵略性。' },
      { id: 'q23', text: '所谓合作，就是指在追求越来越大同一性的过程中，也就是在追求越来越多近乎相互满足的过程中，并在维持越来越相似的安全措施之际，一方明显地按照另一方表明了的需求调整自己的行为。——沙利文' },
      { id: 'q24', text: '两个人之间的真正冲突，那些不是用作掩饰或投射的冲突，而是在它们所属的内在真实的深刻层次被体验到的冲突，并不是破坏性的。这种冲突会通向澄心，让双方得到净化，变得更有知识和力量。' },
      { id: 'q25', text: '只有当两个人各从自己生命的中心体验到自己，爱才可能产生。以这种方式体验的爱，爱乃是一项不断的挑战，它不是一个歇息之地，而是一同行动，一同成长，一同劳作。' },
      { id: 'q26', text: '爱的存在只有一个证明：关系深邃，双方各有活泼和强壮的生命力，这是爱的果实，也是爱赖以被辨识的标志。' },
      { id: 'q27', text: '在爱的艺术上，玩票者似乎特别多，行家里手似乎特别少。任何想要成为行家的人，在生命的每个阶段都必须实践纪律、专注和耐心。' },
      { id: 'q28', text: '在实践这些纪律时，不可把它们当成外力强加在我们身上的束缚，应当让它们成为我们意志的表达，我们应该是心甘情愿，而且久而久之成为习惯之后，反而会因为不去实践而觉得若有所失。' },
      { id: 'q29', text: '事实上，能够专注意味着能够独处，而这种能力正是爱的能力的前提。如果我只因为无法自己站立而依恋别人，那对方就会成为我的救生员，但我们的关系不会是爱的关系。' },
      { id: 'q30', text: '自恋的反面是客观性，是按照事物本然的样子看待它们的能力，是能够把这幅客观图像和根据一己欲望与恐惧所形成的图像区分开来的能力。' },
      { id: 'q31', text: '审视国与国的关系或人与人的关系，我们都会得出一个结论：客观是例外，或多或少的自恋性扭曲为常规。' },
      { id: 'q32', text: '掌管客观思考的机能为理性，理性背后的感情是谦卑。只有当一个人能够谦卑，只有当他脱离了以为自己全知全能的儿童期迷梦之后，他才可能客观，才能够运用自己的理性。' },
      { id: 'q33', text: '发展谦卑、客观性和理性，人的整个生命都必须为此而努力。' },
      { id: 'q34', text: '在人类关系的领域，信仰也是任何重要的友谊和爱中不可少的素质。对别人有信心，意味着我确定他的基本态度、他的人格核心和他的爱是可靠且不会改变的。' },
      { id: 'q35', text: '对自己有信仰，是我们有能力做出承诺的前提。我们应该信任自己的爱，相信这爱有能力唤起他人心里的爱，相信这爱的可靠性。' },
      { id: 'q36', text: '会去爱、会快乐、会使用理性和具备艺术禀赋的都属于这一类潜能。它们是一些种子，遇到适当条件会发芽生长，遇不到适当条件会窒息。' },
      { id: 'q37', text: '有信仰的前提是有勇气，有去冒险的能力，随时准备好接受痛苦和失望。' },
      { id: 'q38', text: '爱和被爱都需要勇气，断定某些价值无比重要的勇气，把一切压注在这些价值上的勇气。' },
      { id: 'q39', text: '虽然我们在意识层面害怕的是不被人爱，但我们真正恐惧（通常是无意识的）是去爱。' },
      { id: 'q40', text: '爱的能力要求一种强烈的、清醒的、活力加倍的状态。如果一个人在其他领域不具有创造性，那他在爱的领域也不会具有创造性。' }
    ]
  },
];
