...
var blogPosts = [
...

  {
    ...
    content: `
      ...
      <p>太久远的记不清了，初中以前都比较贪玩，成绩平平。就从中学说起吧。八年制的我，勉强算是一个在应试教育中取得胜利的学生，初高中生活确实仰赖体系完善的笔记本。上高中之前，应该是疫情阶段的网课，我在网上看到了Whynot错题本，是一个上交大的人分享的他的笔记，他记得很全，对于如何做笔记和做错题本都有很好的参考。那时我大为震撼，彼时虽已经格式化整理笔记和错题本多年，但何泰然师兄的整理给我一种全新的视角。</p>
      <p>我很喜欢手写笔记的感觉，认为知识体系整理的过程就是把一团麻线整理清楚一样的过程。做笔记是为了更好地记忆知识点，切勿流于表面。越来越长大，我愈加发现，我们并不是为了展示与证明，许多过程，或是乐在其中，或是为自己有一个交代就足够了。记得初三的时候拿着邻居老姨赠予的100页本子，我便生出现在离中考还有100天，我一天整理一道错题，把这本本子写满便上考场的豪情。最后虽然没有写满100页，数学也只是过得去的水平（110/120），却意外收获了学业特别奖奖学金。可见，有的时候，就是需要“但行好事，莫问前程”。这个过程坚持下来，也让曾经的同学发出来“你变了，又好像没变”的评价。</p>
      <p>中考结束的时候，我参加了汕头金中的自主招生。其实我的数理化并没有我金中三年那些同学好，那时三年的高中生活也让我接受了作为一个“平庸”的存在。我还是比较庆幸自己以优异的中考成绩加成通过自主招生进入理科试验班（信息学方向）的，即使三年中我被C语言和各种数理难题虐得体无完肤。在困境中指引我方向的，还是读书与整理知识体系。我在RedNote上有发表过一篇关于高三笔记整理的拙见，此处不再过多赘述，大抵关键是专题意识与领域词汇积累，后来数年，面对高等数学等理工类课程，我也采取类似方法肢解。这个过程中，我开始不再在乎自己因为考试获得的不那么好的及时评价，也逐渐忽略了身旁的喧嚣，直至最近又被许多事情扰得心烦时，一位师兄给出了“结庐在人境，而无车马喧”的点破，我又想起了那时笃行的模样。可是当时我们好像只有一个目标，现在，我们有太多太多的路要走。</p>
      <p>那时稚嫩的笔迹写出来的知识体系，现在看来不失一种回忆。活页本的厚重带给我困境中的成就感，也让我养成了条理性与纪律性。每做完一个专题，不管有过多少个红叉，都要继续往前走。</p>
      <p>进入大学，无纸化的风也吹到了我身边，活页本的厚重似乎被视为一种旧时代的糟粕，大家喜欢用平板记笔记。我却独爱纸质书的厚重，课堂随记依然记录在课本上，虽然每次背着蓝色生死恋上学时会觉得自己似乎在横跨太平洋。在大一的理工科课程以及系统解剖学，我依然习惯于活页本与A4纸，到OneNote学习。OneNote我也用了很久，我很喜欢它无限延展的画布以及侧边栏设计。同时我开始使用Word，发现了Word中可以打书签。那个时候，我用Word和OneNote完成了大一大二很多笔记，包括后来流传颇广的有机化学，医学遗传学笔记。系统化笔记的方式让我取得了不错的绩点，也拿下了国家奖学金。虽然绩点仅仅作为面试的入场券，后来在大三我也迎来了医学课程高压下的绩点猛降，但彼时我通过这种方式，每一天都有每一天的雀跃，进一步有进一步的欢喜。</p>
      <p>直到最近，我开始使用Obsidian，起初是在组会和团队文档中看到师兄建设得相当完善的obsidian笔记，决定狠下心来试试。直接促使我转向Obsidian的原因是我的Claude账户被封号了，我不得不导出我的数据。这时候，Obsidian就成为了一个关键选择，然后便一发不可收拾。早在三年之前，我就有听过Obsidian的功能强大之处，但一直对它的复杂度望而生畏。实际上入门之后发现并不难。很多时候，Obsidian只是作为一个容器，储存我遇到的知识，分门别类地摆放好，包括使用网页插件捕获下YouTube的知识。而Markdown语法，实质也并不难学；在使用Obsidian作为大本营之前，我很长时间潜伏在VS code中，很多打开Markdown浏览的过程我都是使用VS code完成的；VS code的插件市场也十分齐全。彼时使用VS code还可以非常方便地对我建设的网页进行编辑。在VS code中使用Markdown记笔记的过程，也为我后来的一个网站: 南医八年知识库（[https://july0709.github.io/SMU-eight-year/）的建设埋下了伏笔。毕竟，准备的食材越丰富，能够做出的菜肴越多样。](https://july0709.github.io/SMU-eight-year/）的建设埋下了伏笔。毕竟，准备的食材越丰富，能够做出的菜肴越多样。)</p>
      <p>如今，我已经将Obsidian作为我科研知识的大本营。这么多年过去，工具的变迁背后是现实情境的不同。以前我整理知识，是因为考试终究有一个范围；现在整理知识，却是在面对一个没有边界的问题。但好像有些事情一直没有改变：面对一团麻线，先坐下来，把它一点点理清楚。可能，这也是经常在研究场合听到——你要讲好一个故事——背后的深意吧。</p>
    `,
    titleEn: "The Evolution of My Knowledge System: From Exam Preparation to Research Life",
    excerptEn: "Lately, while exploring how to build a personal knowledge base, I suddenly felt compelled to write a history of how my own knowledge system has evolved.",
    contentEn: `
      <p>Lately, while exploring how to build a personal knowledge base, I suddenly felt compelled to write a history of how my own knowledge system has evolved.</p>
      <p>My memories from much earlier are hazy. Before middle school, I was mostly playful and my grades were unremarkable, so I will begin with my secondary-school years. As someone now in an eight-year medical programme, I can just about count myself among those who succeeded within the exam-oriented education system. Throughout middle and high school, I relied heavily on a well-developed system of notebooks. Before I entered high school, probably during the period of online classes amid the pandemic, I came across the Whynot error notebook online. It was shared by a student at Shanghai Jiao Tong University, whose notes were remarkably comprehensive and offered an excellent reference for both note-taking and maintaining an error notebook. I was astonished. Although I had already spent years organising notes and mistakes into standardised formats, senior student He Tairan's system gave me an entirely new perspective.</p>
      <p>I have always loved the feeling of writing notes by hand. To me, organising a knowledge system is like patiently untangling a knotted bundle of thread. The purpose of taking notes is to remember knowledge more effectively; it must never become an exercise in appearances. As I grow older, I increasingly realise that we do not have to display or prove everything we do. For many pursuits, it is enough either to find joy in the process or simply to give ourselves an honest account. I remember that, in my third year of middle school, an older neighbour gave me a 100-page notebook. With 100 days left before the high school entrance examination, I was suddenly filled with the heroic ambition to organise one wrong answer every day, fill the entire notebook, and then walk into the examination hall. In the end, I did not fill all 100 pages, and my mathematics score was only respectable rather than exceptional (110/120), yet I unexpectedly received a Special Academic Achievement Scholarship. Sometimes, it seems, what we need is simply to "do what is right and ask not what the future holds." Persisting with that process also led a former classmate to remark, "You've changed, and yet somehow you haven't."</p>
      <p>After the high school entrance examination, I took part in the independent admissions process at Shantou Jinshan Middle School. In truth, my mathematics, physics, and chemistry were never as strong as those of many classmates I later met there. Those three years of high school also taught me to accept myself as an "ordinary" person. Still, I remain grateful that my strong entrance-examination results helped me pass the independent admissions process and enter the science experimental class in the informatics track, even though C programming and countless mathematical and scientific problems left me thoroughly battered over the next three years. What continued to guide me through difficulty was reading and organising my knowledge system. I once posted some modest thoughts on RedNote about organising notes in the final year of high school, so I will not repeat them at length here. The central ideas were developing a sense of topics and accumulating the vocabulary of a field. In the years that followed, I used a similar method to break down advanced mathematics and other science and engineering courses. Through this process, I stopped caring so much about the less-than-ideal immediate judgements produced by examinations and gradually learned to ignore the noise around me. Recently, when many things once again left me unsettled, a senior student offered the line, "I built my hut in the human world, yet hear no noise of carts and horses," and suddenly reminded me of how steadfastly I had once moved forward. Back then, however, we seemed to have only one goal. Now there are so many, many roads before us.</p>
      <p>The knowledge systems written in my immature handwriting have now become memories in their own right. The physical weight of loose-leaf notebooks gave me a sense of achievement in difficult times, while also teaching me order and discipline. Whenever I completed a topic, no matter how many red crosses it contained, I had to keep moving forward.</p>
      <p>When I entered university, the wave of paperless learning reached me as well. The weight of loose-leaf notebooks seemed to be regarded as a relic of an earlier age, while everyone preferred taking notes on tablets. I, however, remained devoted to the substance of printed books and continued writing class notes directly in my textbooks, even though carrying those blue "life-or-death romance" volumes to class sometimes felt like crossing the Pacific. For the science and engineering courses of my first year, as well as systematic anatomy, I still relied on loose-leaf notebooks and A4 paper before moving to OneNote. I used OneNote for a long time and loved its infinitely expandable canvas and sidebar design. I also began using Word and discovered that documents could contain bookmarks. With Word and OneNote, I completed many of my notes during my first and second years, including the organic chemistry and medical genetics notes that later circulated quite widely. This systematic approach to note-taking helped me earn a strong grade-point average and a National Scholarship. A GPA is ultimately only an admission ticket to an interview, and in my third year my own fell sharply under the pressure of intensive medical courses. At that time, however, this method gave me something to celebrate every day and fresh delight with every step forward.</p>
      <p>Only recently did I begin using Obsidian. At first, I saw the remarkably well-developed Obsidian notes maintained by a senior student in our group meetings and team documents, and finally decided to commit myself to trying it. The immediate reason I moved to Obsidian was that my Claude account had been suspended, forcing me to export my data. At that point, Obsidian became the obvious choice, and from there I became completely absorbed in it. I had already heard about Obsidian's powerful capabilities three years earlier, but its apparent complexity had always intimidated me. Once I began, however, I discovered that getting started was not difficult at all. Much of the time, Obsidian is simply a container: a place to store the knowledge I encounter and arrange it by category, including material captured from YouTube with a web-clipping plugin. Markdown syntax is not difficult to learn either. Before making Obsidian my home base, I spent a long time working in VS Code and used it to open and browse Markdown files. VS Code also has an exceptionally comprehensive extension marketplace, and at the time it allowed me to edit the websites I was building with great ease. Taking notes in Markdown within VS Code also laid the groundwork for a website I later created: the <a href="https://july0709.github.io/SMU-eight-year/" target="_blank" rel="noopener noreferrer">SMU Eight-Year Programme Knowledge Base</a>. After all, the richer the ingredients we prepare, the greater the variety of dishes we can make.</p>
      <p>Today, Obsidian has become the central home for my research knowledge. After all these years, the evolution of my tools reflects the changing realities around me. In the past, I organised knowledge because an examination ultimately had a defined scope. Now I organise knowledge while confronting questions without boundaries. Yet something seems never to have changed: when faced with a tangled bundle of thread, I sit down first and patiently work through it, strand by strand. Perhaps this is also the deeper meaning behind something we so often hear in research: you have to tell a good story.</p>
    `
  }
